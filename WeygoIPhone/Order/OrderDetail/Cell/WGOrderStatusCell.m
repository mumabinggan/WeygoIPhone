    ...
    if (orderStatus) {
        if (_timeArray == nil) {
            ...
            for (int num = 0; num < 3; ++num) {
                ...
                JHLabel *timeLabel = [[JHLabel alloc] initWithFrame:CGRectMake(kAppAdaptWidth(15), height * num, kAppAdaptWidth(145), height)];
                ...
                JHLabel *statusLabel = [[JHLabel alloc] initWithFrame:CGRectMake(kAppAdaptWidth(191), height * num, kDeviceWidth - kAppAdaptWidth(95), height)];
            ...
            [linePath moveToPoint:CGPointMake(kAppAdaptWidth(171), kAppAdaptHeight(24))];
            [linePath addLineToPoint: CGPointMake(kAppAdaptWidth(171), kAppAdaptWidth(120))];
            ...
            if (orderStatus.currentStatus == 1) {
                ...
                UIBezierPath *linePath = [UIBezierPath bezierPath];
                [linePath addArcWithCenter:CGPointMake(kAppAdaptWidth(171), kAppAdaptHeight(24)) radius:kAppAdaptHeight(6) startAngle:0.0 endAngle:180.0 clockwise:YES];
                ...
                UIBezierPath *linePath = [UIBezierPath bezierPath];
                [linePath moveToPoint:CGPointMake(kAppAdaptWidth(171), kAppAdaptHeight(24))];
                [linePath addLineToPoint: CGPointMake(kAppAdaptWidth(171), kAppAdaptWidth(72))];
                layer.path = linePath.CGPath;
                layer.opacity = 1.0;
                layer.lineWidth = kAppAdaptWidth(8);
                layer.lineCap = kCALineCapRound;
                ...
                [circleLinePath addArcWithCenter:CGPointMake(kAppAdaptWidth(171), kAppAdaptHeight(24)) radius:kAppAdaptHeight(6) startAngle:0.0 endAngle:180.0 clockwise:YES];
                ...
                [circleLinePath1 addArcWithCenter:CGPointMake(kAppAdaptWidth(171), kAppAdaptHeight(72)) radius:kAppAdaptHeight(6) startAngle:0.0 endAngle:180.0 clockwise:YES];
                ...
                [circleLinePath2 addArcWithCenter:CGPointMake(kAppAdaptWidth(171), kAppAdaptHeight(120)) radius:kAppAdaptHeight(6) startAngle:0.0 endAngle:180.0 clockwise:YES];
